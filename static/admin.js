...
function editModpack(m) {
  ...
  openEditModal('编辑整合包', [
    ...
    { k: 'mod_loader', label: '加载器', v: m.mod_loader, select: ['vanilla','forge','neoforge','fabric','quilt'] },
...
function editMod(m) {
  ...
  openEditModal('编辑模组', [
    ...
    { k: 'game', label: '游戏', v: m.game },
    { k: 'game_version', label: '游戏版本', v: m.game_version || '' },
    { k: 'mod_loader', label: '加载器', v: m.mod_loader || 'vanilla', select: ['vanilla','forge','neoforge','fabric','quilt'] },
